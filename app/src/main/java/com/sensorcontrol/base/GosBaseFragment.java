...
public class GosBaseFragment extends Fragment{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        spf = mActivity.getSharedPreferences(SPF_Name, Context.MODE_PRIVATE);
        MessageCenter.getInstance(mActivity);
        // 初始化
        setProgressDialog();
    }
    ...
    PermissionListener mypermissionlistener = new PermissionListener() {
        ...
        public void onSucceed(int requestCode, List<String> grantPermissions) {
            GosBaseFragment.this.onSucceed(requestCode,grantPermissions);
        }

        @Override
        public void onFailed(int requestCode, List<String> deniedPermissions) {
            GosBaseFragment.this.onFailed(requestCode,deniedPermissions);
        }
    };
